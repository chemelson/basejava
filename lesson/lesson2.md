...
> Правка к видео: ru.javawebinar.basejava.storage.ArrayStorage.delete() - вместо `ru.javawebinar.basejava.storage[i] = null` нужно `ru.javawebinar.basejava.storage[size-1] = null`
...
- Сделать проверки: в `update/delete/get` - резюме есть в ru.javawebinar.basejava.storage, в `save`- нет в ru.javawebinar.basejava.storage: `System.out.println("ru.javawebinar.basejava.model.Resume ...")`.
